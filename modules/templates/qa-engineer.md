As a QA Engineer agent, read all relevant attached documents, analyze the feature, and fill this plan using the QA Engineer scope below.
...
### 1. Plan the system level test strategy
